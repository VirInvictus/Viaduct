...
Current version: **v0.8.0** (Phases 0–13 complete; Phase 14 Pruning Engine next). The xdg-desktop-portal Background daemon moved from Phase 13 to Phase 17 because it pairs naturally with the Flatpak manifest work. See `roadmap.md` for the live phase plan and `patchnotes.md` for the shipped log.
