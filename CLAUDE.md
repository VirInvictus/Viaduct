...
Current version: **v0.7.0** (Phases 0–12 complete; Phase 13 System Integration & Theming next). See `roadmap.md` for the live phase plan and `patchnotes.md` for the shipped log.
